...
/**
 * @ngdoc object
 * @name lbServices.Target
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Target` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Target#create
         * @methodOf lbServices.Target
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         */
        "exists": {
          url: urlBase + "/targets/:id/exists",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Target#findById
         * @methodOf lbServices.Target
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/targets/:id",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Target#find
         * @methodOf lbServices.Target
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Target#findOne
         * @methodOf lbServices.Target
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/targets/findOne",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Target#updateAll
         * @methodOf lbServices.Target
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/targets/update",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.Target#deleteById
         * @methodOf lbServices.Target
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/targets/count",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Target#prototype$updateAttributes
         * @methodOf lbServices.Target
         *
         * @description
         *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Deployment#upsert
         * @methodOf lbServices.Deployment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Deployment#exists
         * @methodOf lbServices.Deployment
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/deployments/:id/exists",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Deployment#findById
         * @methodOf lbServices.Deployment
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/deployments/:id",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Deployment#find
         * @methodOf lbServices.Deployment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Deployment#findOne
         * @methodOf lbServices.Deployment
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/deployments/findOne",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Deployment#updateAll
         * @methodOf lbServices.Deployment
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/deployments/update",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.Deployment#deleteById
         * @methodOf lbServices.Deployment
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Deployment#count
         * @methodOf lbServices.Deployment
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/deployments/count",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Deployment#prototype$updateAttributes
         * @methodOf lbServices.Deployment
         *
         * @description
         *
